              ...
              return (
                <motion.div
                  ...
                  className={cn(
                    ...
                    "will-change-transform select-none transition-shadow",
                    isActive
    ...
    <div className="relative h-full w-full bg-white dark:bg-gray-900">
      ...
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-gray-100 text-sm text-gray-400 font-bold uppercase tracking-widest">
            Explore {item.title}
          </div>
        )}
      </div>
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-8 text-white">
        <div className="flex justify-between items-end">
          <div className="max-w-[70%]">
            <div className="truncate text-2xl font-black tracking-tight mb-1">
              {item.title}
            </div>
            {item.description ? (
              <div className="line-clamp-2 text-sm text-white/70 font-medium">
                {item.description}
              </div>
            ) : null}
          </div>
          {item.tag && (
            <div className="bg-blue-600 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest mb-1.5 self-start">
              {item.tag}
            </div>
          )}
        </div>
